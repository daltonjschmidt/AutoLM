...
leagues = {'1064695173143212032': 2024,'920151115868565504': 2023,'784647533929566208':2022,'650929906032680960':2021,'593899679217930240':2020}
...
postgres.create_table_and_insert_data(rosters, "rosters", conn,1)
postgres.create_table_and_insert_data(users, "users", conn,1)
postgres.create_table_and_insert_data(league, "league", conn,1)
postgres.create_table_and_insert_data(player_performances, "player_performances", conn,1)
postgres.create_table_and_insert_data(weekly_summaries, "weekly_summaries", conn,1)
postgres.create_table_and_insert_data(transactions, "transactions", conn,1)
#postgres.create_table_and_insert_data(playoffs, "playoffs", conn,1)
postgres.create_table_and_insert_data(players, "players", conn,1)
postgres.create_table_and_insert_data(drafts, "drafts", conn,1)
